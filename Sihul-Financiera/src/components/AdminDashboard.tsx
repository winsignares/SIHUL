...
import CentroHorarios from './admin/CentroHorarios';
...
import AsignacionAutomatica from './admin/AsignacionAutomatica';
import EstadoRecursos from './admin/EstadoRecursos';
import AsistentesVirtuales from './admin/AsistentesVirtuales';
...
type MenuOption = 'home' | 'facultades' | 'espacios' | 'asignacion' | 'centrohorarios' | 'periodos' | 'reportes' | 'prestamos' | 'recursos' | 'ocupacion' | 'notificaciones' | 'ajustes' | 'chat' | 'usuarios' | 'asistentes';
