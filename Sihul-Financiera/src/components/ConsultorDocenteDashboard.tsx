...
import ConsultorDocenteHome from './consultor/ConsultorDocenteHome';
import HorarioDocente from './consultor/HorarioDocente';
import DocentePrestamos from './consultor/DocentePrestamos';
...
type MenuOption = 'home' | 'horario' | 'prestamos' | 'notificaciones' | 'ajustes';
...
export default function ConsultorDocenteDashboard({ userName, onLogout }: ConsultorDocenteDashboardProps) {
  ...
  const renderContent = () => {
    switch (activeMenu) {
      case 'home':
        return <ConsultorDocenteHome onNavigate={setActiveMenu} />;
      case 'horario':
