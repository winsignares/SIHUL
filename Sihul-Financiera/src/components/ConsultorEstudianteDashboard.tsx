...
import ConsultorEstudianteHome from './consultor/ConsultorEstudianteHome';
import HorarioEstudiante from './consultor/HorarioEstudiante';
...
export default function ConsultorEstudianteDashboard({ userName, onLogout }: ConsultorEstudianteDashboardProps) {
  ...
  const renderContent = () => {
    switch (activeMenu) {
      case 'home':
        return <ConsultorEstudianteHome onNavigate={setActiveMenu} />;
      case 'horario':
