...
import ContabilidadHome from './contabilidad/ContabilidadHome';
import RadicarFacturas from './contabilidad/RadicarFacturas';
import CausarFacturas from './contabilidad/CausarFacturas';
import MisPendientes from './contabilidad/MisPendientes';
...
type MenuOption = 'home' | 'radicar' | 'causar' | 'pendientes';

export default function ContabilidadDashboard({ userName, onLogout }: ContabilidadDashboardProps) {
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'radicar', icon: FileCheck, label: 'Radicar Facturas', action: 'radicar' },
        { id: 'causar', icon: Calculator, label: 'Causar Facturas', action: 'causar' }
      ]
    }
  ];
  ...
  const renderContent = () => {
    switch (activeMenu) {
      case 'home':
        return <ContabilidadHome onNavigate={setActiveMenu} />;
      case 'radicar':
          ...
          <div className="p-6 border-b border-red-700/50 flex items-center justify-center">
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                <Calculator className="w-7 h-7 text-red-900" />
              </div>
              <AnimatePresence>
                {!isSidebarCollapsed && (
                  <motion.div
                  ...
                  >
                    ...
                    <p className="text-red-300 whitespace-nowrap">Contabilidad</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400">Sistema de Contabilidad</p>
                </div>
              </div>
              ...
              <div className="hidden md:flex flex-1 max-w-xl">
                <div className="relative w-full">
                  ...
                  <Input
                    placeholder="Buscar facturas, radicados..."
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <div className="hidden lg:block">
                    ...
                    <p className="text-slate-500">Contabilidad</p>
                  </div>
                </motion.div>
              </div>
            </div>
