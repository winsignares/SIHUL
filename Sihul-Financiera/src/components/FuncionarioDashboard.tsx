import FuncionarioHome from './funcionario/FuncionarioHome';
import RegistrarFactura from './funcionario/RegistrarFactura';
import ConsultarFacturas from './funcionario/ConsultarFacturas';
import MisPendientes from './funcionario/MisPendientes';
...
type MenuOption = 'home' | 'registrar' | 'consultar' | 'pendientes';

export default function FuncionarioDashboard({ userName, onLogout }: FuncionarioDashboardProps) {
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'registrar', icon: Receipt, label: 'Registrar Factura', action: 'registrar' },
        { id: 'consultar', icon: FileSearch, label: 'Consultar Facturas', action: 'consultar' }
      ]
    }
  ];
  ...
  const renderContent = () => {
    switch (activeMenu) {
      case 'home':
        return <FuncionarioHome onNavigate={setActiveMenu} />;
      case 'registrar':
          ...
          <div className="p-6 border-b border-red-700/50 flex items-center justify-center">
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                <DollarSign className="w-7 h-7 text-red-900" />
              </div>
              <AnimatePresence>
                {!isSidebarCollapsed && (
                  <motion.div
                  ...
                  >
                    ...
                    <p className="text-red-300 whitespace-nowrap">Cuentas x Pagar</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400">Sistema de Cuentas por Pagar</p>
                </div>
              </div>
