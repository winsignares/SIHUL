...
import universityImage from 'figma:asset/64aaf13bd617818be1912d4537da5d87799bf2a4.png';

type UserRole = 'admin' | 'autorizado' | 'consultor' | 'consultor-estudiante' | 'consultor-docente' | 'supervisor-salones' | 'funcionario' | 'contabilidad' | 'tesoreria' | 'auditoria' | 'sindicatura' | 'presidencia' | 'director-financiero' | null;
