...
import SupervisorSalonHome from './supervisor/SupervisorSalonHome';
...
interface SupervisorSalonDashboardProps {
  userName: string;
  onLogout: () => void;
}

type MenuOption = 'home' | 'notificaciones' | 'ajustes';

export default function SupervisorSalonDashboard({ userName, onLogout }: SupervisorSalonDashboardProps) {
  ...
  const menuSections = [
    {
      ...
      label: 'PRINCIPAL',
      items: [
        { id: 'home', icon: DoorOpen, label: 'Gestión de Salones', action: 'home' }
      ]
    }
  ];
              ...
              <AnimatePresence>
                {!isSidebarCollapsed && (
                  ...
                  >
                    ...
                    <p className="text-red-300 whitespace-nowrap">Supervisor</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400">Sistema de Gestión de Salones</p>
                </div>
              </div>
