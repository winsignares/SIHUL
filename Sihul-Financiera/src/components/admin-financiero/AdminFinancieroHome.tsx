...
import {
  ShieldCheck, Users, BarChart3, DollarSign, TrendingUp, Clock,
  CheckCircle2, AlertTriangle, FileText, Activity, Eye, Settings
} from 'lucide-react';
...
export default function AdminFinancieroHome({ onNavigate }: AdminFinancieroHomeProps) {
  ...
  const statsGlobales = [
    ...
    },
    {
      ...
      trend: '15 pendientes hoy',
      action: () => onNavigate('reportes')
    },
    {
      title: 'Monto Total en Trámite',
      value: '$847M',
      icon: DollarSign,
    ...
    {
      title: 'Tiempo Promedio Proceso',
      value: '5.2 días',
      icon: Clock,
      color: 'from-purple-600 to-purple-700',
      iconColor: 'text-purple-100',
      trend: '-0.8 vs mes anterior',
      action: () => onNavigate('reportes')
    }
  ];
  ...
  const distribucionEstados = [
    ...
    { estado: 'Aprobada Auditoría', cantidad: 17, porcentaje: 13, color: 'bg-orange-500' },
  ...
  const actividadesRecientes = [
    {
      id: '1',
      usuario: 'María González (Tesorería)',
      accion: 'Alistó factura para pago',
    ...
    {
      id: '2',
      usuario: 'Carlos Ruiz (Auditoría)',
      accion: 'Aprobó control previo',
      numeroFactura: 'FAC-2026-0145',
      proveedor: 'Tecnología y Equipos Ltda.',
      valorTotal: 12800000,
    ...
    {
      id: '3',
      usuario: 'Ana López (Contabilidad)',
      accion: 'Causó factura en el sistema',
      numeroFactura: 'FAC-2026-0138',
    ...
    {
      id: '4',
      usuario: 'Pedro Martínez (Dir. Financiera)',
      accion: 'Cargó pagos para autorización',
    ...
    {
      id: '5',
      usuario: 'Rectoría (Sistema)',
      accion: 'Autorizó pago de factura',
      numeroFactura: 'FAC-2026-0125',
  ...
  // Métricas de rendimiento por rol
  const rendimientoPorRol = [
    ...
    { rol: 'Tesorería', tareasPendientes: 15, tareasCompletadas: 42, eficiencia: 74 },
    { rol: 'Auditoría', tareasPendientes: 10, tareasCompletadas: 35, eficiencia: 78 },
    { rol: 'Dir. Financiera', tareasPendientes: 5, tareasCompletadas: 28, eficiencia: 85 },
    { rol: 'Rectoría', tareasPendientes: 3, tareasCompletadas: 25, eficiencia: 89 }
  ];
      ...
      <div className="p-8 space-y-8">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-white mb-1">Panel de Administración Financiera</h1>
        ...
        {/* Distribución por Estado y Actividad Reciente */}
            ...
            <Card className="border-0 shadow-lg h-full">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-slate-800">
                  ...
                  Distribución por Estado del Flujo
                </CardTitle>
        ...
        >
          <Card className="border-0 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Métricas de eficiencia de cada departamento</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {rendimientoPorRol.map((rol, index) => (
                  <motion.div
                    ...
                    transition={{ delay: index * 0.05 }}
                    className="p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-red-300 hover:shadow-md transition-all"
                  >
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="font-semibold text-slate-800">{rol.rol}</h4>
                      <Badge className={`${rol.eficiencia >= 80 ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
                        {rol.eficiencia}%
                      </Badge>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-semibold text-orange-600">{rol.tareasPendientes}</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-slate-600">Completadas:</span>
                        <span className="font-semibold text-green-600">{rol.tareasCompletadas}</span>
                      </div>
                    </div>
                    <div className="mt-3 w-full bg-slate-200 rounded-full h-2 overflow-hidden">
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${rol.eficiencia}%` }}
                        transition={{ delay: index * 0.1, duration: 0.5 }}
                        className={`h-full ${rol.eficiencia >= 80 ? 'bg-green-500' : 'bg-yellow-500'}`}
                      ></motion.div>
                    </div>
                  </motion.div>
                ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <Card
              ...
              className="border-0 shadow-lg hover:shadow-2xl transition-all cursor-pointer group bg-gradient-to-br from-blue-600 to-blue-700 text-white"
            >
              <CardContent className="p-6">
          ...
          >
            <Card
              ...
              className="border-0 shadow-lg hover:shadow-2xl transition-all cursor-pointer group bg-gradient-to-br from-green-600 to-green-700 text-white"
            >
              <CardContent className="p-6">
                ...
                <p className="text-green-100 text-sm">Ver métricas, estadísticas y exportar datos</p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card
              ...
              className="border-0 shadow-lg hover:shadow-2xl transition-all cursor-pointer group bg-gradient-to-br from-purple-600 to-purple-700 text-white"
            >
              <CardContent className="p-6">
                ...
                <p className="text-purple-100 text-sm">Ajustes del sistema y parámetros generales</p>
              </CardContent>
            </Card>
          </motion.div>
        </div>
