...
import { 
  BarChart3, Download, TrendingUp, DollarSign, Clock, 
...
export default function ReportesConsolidados() {
  const reportesDisponibles = [
    ...
    },
    {
      ...
      descripcion: 'Análisis de tiempos por etapa del flujo de cuentas por pagar',
      icon: Clock,
      color: 'from-blue-600 to-blue-700',
      registros: 127,
      totalMonto: '5.2 días promedio'
    },
    {
    ...
    {
      titulo: 'Facturas por Área Solicitante',
      descripcion: 'Distribución de gastos por área administrativa',
      icon: FileText,
    ...
    {
      titulo: 'Histórico Mensual',
      descripcion: 'Comparativa de facturación mes a mes',
      icon: TrendingUp,
    ...
    <div className="p-8 space-y-6">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-white mb-1">Reportes Consolidados</h1>
            <p className="text-red-100 text-sm">
              Analítica, estadísticas y exportación de datos del sistema
            </p>
          </div>
        </div>
      </motion.div>
