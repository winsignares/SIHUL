...
import { Plus, Edit, Trash2, Building2, Search, Users, X, Check, AlertTriangle, BookOpen, GitMerge, MapPin, Boxes } from 'lucide-react';
...
export default function FacultadesPrograms() {
  ...
  const [activeTab, setActiveTab] = useState<'facultades' | 'programas' | 'grupos' | 'asignaturas' | 'fusion' | 'espacios' | 'recursos'>('facultades');
