...
_ALIAS_MAP = {
    'registro por parte del funcionario': ['recepcion y registro', 'registro y recepcion', 'recepcion funcionario', 'registro funcionario'],
    'recepcion y registro': ['registro por parte del funcionario'],
    'registro funcionario': ['registro por parte del funcionario'],
    'radicacion y causacion': ['radicacion', 'radicacion contable', 'causacion', 'causacion contable'],
    'radicacion': ['radicacion y causacion'],
    'radicacion contable': ['radicacion y causacion'],
    'causacion': ['radicacion y causacion'],
    'causacion contable': ['radicacion y causacion'],
    'autorizacion de pago': ['autorizacion rectoria', 'envio a rectoria', 'control de pago bancario'],
    'autorizacion rectoria': ['autorizacion de pago'],
    'envio a rectoria': ['autorizacion de pago'],
    ...
    'cargue formal': ['envio a direccion financiera', 'direccion financiera', 'cargue formal'],
    'envio a direccion financiera': ['cargue formal'],
    'direccion financiera': ['cargue formal'],
    'control de pago bancario': ['autorizacion de pago'],
