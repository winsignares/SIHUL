...
Cada responsabilidad de seed está delegada a su propio módulo en seeders/:
  ...
  asignaturas_programa_seeder, espacios_seeder, espacios_permitidos_seeder,
  componentes_seeder, componentes_rol_seeder, periodos_seeder, grupos_seeder,
  horarios_seeder, agentes_seeder, preguntas_sugeridas_seeder.
