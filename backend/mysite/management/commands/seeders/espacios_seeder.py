...
def create_espacios_fisicos(stdout, style):
    ...
    tipo_sala_computo = TipoEspacio.objects.get(nombre='Sala Cómputo')
    ...
    espacios_data = [
        ...
        ('SALA COMPUTO LABORATORIOS', sede_principal, tipo_sala_computo, 30, 'N/A'),
        ('SALON 203B', sede_principal, tipo_salon, 50, 'N/A'),
        ('SALON 204B', sede_principal, tipo_salon, 50, 'N/A'),
