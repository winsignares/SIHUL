...
ESTADOS_CONFIG = [
    ('Recibida',               'Recepción y Registro',          'REC'),
    ('Registrada',             'Radicación',                    'REG'),
    ('Radicada',               'Alistamiento',                  'RAD'),
    ('Causada',                'Alistamiento',                  'CAU'),
    ('Alistada',               'Control Previo',                'ALI'),
    ('Aprobada Auditoría',     'Envío a Dirección Financiera',  'APA'),
    ('Rechazada Auditoría',    'Control Previo',                'RPA'),
    ('Revisada Dir. Financiera', 'Cargue Formal',               'RDF'),
    ('Cargada',                'Envío a Rectoría',              'CAR'),
    ('Enviada Rectoría',       'Aplicación de Pago',            'ERC'),
    ('Autorizada',             'Aplicación de Pago',            'AUT'),
    ('Rechazada por Rectoría', 'Cargue Formal',                 'RRC'),
    ('Pago Aplicado',          'Pago Aplicado',                 'PAG'),
    ('Pagada',                 'Pago Aplicado',                 'PGD'),
    ('Devuelta',               'Recepción y Registro',          'DEV'),
    ('Detenida',               'Alistamiento',                  'DET'),
    ('Rechazada',              'Recepción y Registro',          'REJ'),
    ('Anulada',                'Recepción y Registro',          'ANU'),
] 
