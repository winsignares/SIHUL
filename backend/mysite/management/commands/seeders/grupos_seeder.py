...
def create_grupos(stdout, style):
    ...
    grupos_data = [
        ...
        #Bacteriología
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'I'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'I'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'II'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'II'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'III'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'III'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'IV'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'IV'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'V'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'V'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'VI'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'VI'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'VII'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'VII'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'VIII'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'VIII'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'IX'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'IX'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GA', 'X'),
        ('BACTERIOLOGÍA', '2026-1', 'BACTERIOLOGÍA GB', 'X'),

        #Microbiología
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'I'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'I'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'II'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'II'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'III'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'III'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'IV'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'IV'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'V'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'V'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'VI'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'VI'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'VII'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'VII'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'VIII'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'VIII'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'IX'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'IX'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GA', 'X'),
        ('MICROBIOLOGÍA', '2026-1', 'MICROBIOLOGÍA GB', 'X'),

        # Intrumentación

            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'I'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'I'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'II'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'II'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'III'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'III'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'IV'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'IV'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'V'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'V'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'VI'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'VI'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'VII'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'VII'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'VIII'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'VIII'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'IX'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'IX'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GA', 'X'),
            ('INSTRUMENTACIÓN', '2026-1', 'INSTRUMENTACIÓN GB', 'X'),
