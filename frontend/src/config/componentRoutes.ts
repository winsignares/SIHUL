...
export const COMPONENT_ROUTES: Record<string, string> = {
    ...
    'Gestión de Chatbots': '/admin/chatbots',
    'Gestión de documentación de chatbots': '/admin/chatbots',
    'Gestión de Documentación de Chatbots': '/admin/chatbots',
...
export const COMPONENT_ICONS: Record<string, LucideIcon> = {
    ...
    'Gestión de Chatbots': Wrench,
    'Gestión de documentación de chatbots': FileText,
    'Gestión de Documentación de Chatbots': FileText,
