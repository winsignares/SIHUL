            ...
            {!isPublicAccess && (
              <div className="border-t border-red-700/50 p-4 space-y-2">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-red-600 text-red-100 hover:bg-red-700/60 hover:text-white hover:border-red-500 bg-red-700/30 transition-colors text-sm py-2 h-auto"
                >
