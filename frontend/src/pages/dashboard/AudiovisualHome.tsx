...
import { CheckCircle, Clock, XCircle, Calendar, TrendingUp, AlertCircle, ChevronRight, BarChart3, Boxes } from 'lucide-react';
import { motion } from 'motion/react';
import { Badge } from '../../share/badge';

interface AudiovisualHomeProps {
  onNavigate: (menu: string) => void;
}

export default function AudiovisualHome({ onNavigate }: AudiovisualHomeProps) {
  const estadisticas = [
    { 
      id: 1, 
          ...
          >
            ...
            >
              <CardContent className="p-6">
                ...
                <h3 className="text-slate-900 dark:text-slate-100 mb-1">Préstamos de Espacios</h3>
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">Gestionar solicitudes y aprobaciones</p>
          ...
          >
            ...
            >
              <CardContent className="p-6">
                ...
                <h3 className="text-slate-900 dark:text-slate-100 mb-1">Estado de Recursos</h3>
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">Monitorear equipos y recursos</p>
                <div className="flex items-center text-emerald-600 dark:text-emerald-400 text-sm">
                  <span>Acceder</span>
                  <ChevronRight className="w-4 h-4 ml-1" />
                </div>
          ...
          >
            ...
            >
              <CardContent className="p-6">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">Visualizar disponibilidad de espacios</p>
                <div className="flex items-center text-emerald-600 dark:text-emerald-400 text-sm">
                  <span>Acceder</span>
                  <ChevronRight className="w-4 h-4 ml-1" />
                </div>
