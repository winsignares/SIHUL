        ...
        <CardContent className="space-y-4">
          ...
          {cargando ? (
            ...
            <div className="text-center py-12 text-slate-400">
              ...
              <p className="font-medium">No hay pagos pendientes de autorizacion</p>
              <p className="text-sm mt-1">Los pagos enviados por Direccion Financiera apareceran aqui</p>
            </div>
          ) : (
